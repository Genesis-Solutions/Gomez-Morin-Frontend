...
const RequestDetail = () => {
  ...
  return (
      <div className= {!data.membretatedLetterDoc ? "flex flex-col items-center gap-9 w-full mb-6" : "flex flex-col items-center gap-9 h-full w-full mb-6"}>
